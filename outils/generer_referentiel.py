...
REFERENTIELS ne contient que les versions actives : les versions antérieures
(N1 2016-11-15, N2 2015-01-02, N3 2016-01-01) ont été retirées d'ici et des
migrations Flyway (elles n'étaient plus reproductibles avec la structure de
données actuelle, qui a abandonné la notion de code de bloc). Pour importer
une nouvelle révision fédérale : ajouter son entrée ici, régénérer, et
n'extraire que la partie neuve pour une nouvelle migration Flyway dédiée —
ne pas réémettre les entrées déjà migrées.
Usage   : python3 generer_referentiel.py > /tmp/nouvelle-revision.sql
